...
CREATE DATABASE IF NOT EXISTS `travelwizard` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `travelwizard`;
...
INSERT INTO `contactusrequests` (`id`, `user_id`, `email`, `subject`, `message`, `admin_id`, `answered`, `status`, `created_at`) VALUES
	(1, 2, 'dunworthsophie@gmail.com', 'Test', 'This is a database test', NULL, 0, 'open', '2025-03-14 12:59:05'),
	(2, 2, 'dunworthsophie@gmail.com', 'Test2', 'Test number 2', NULL, 0, 'open', '2025-03-14 14:06:42');
