...
// Set package destination IDs and package ID for this trip
...
<head>
    ...
    <!-- Link to trip-specific CSS file -->
    <link rel="stylesheet" href="css/Trips.css">

    <!-- Link to trip-specific JavaScript (carousel + accordion functionality) -->
    <script defer src="js/TripScript.js"></script>
</head>
<body>

<!-- Include the site's header (menu, logo etc.) -->
    ...
    <section class="package">
        ...
        <div class="trip-details">
            ...
            <div class="info">
                ...
                <!-- Booking Buttons (user can choose between two different departure dates) -->
            ...
            <div class="trip-itinerary">
                ...
                <div class="accordion">
                    <?php
                    // Each part of the trip (Australia and New Zealand)
                    $destinations = [
