...
// Define destination IDs and package IDs (if needed for booking)
...
<head>
    ...
    <!-- Link to trip-specific styles -->
    <link rel="stylesheet" href="css/Trips.css">

    <!-- Link to trip-specific JavaScript (for carousel/accordion) -->
    <script defer src="js/TripScript.js"></script>
</head>
<body>

<!-- Include the page header (menu, logo, etc.) -->
